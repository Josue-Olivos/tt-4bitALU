module tt_um_josue_olivos_alu (clk,
 ...
 sky130_fd_sc_hd__and3b_2 _061_ (.A_N(uio_in[2]),
    .B(uio_in[0]),
    .C(uio_in[1]),
    .X(_000_));
 sky130_fd_sc_hd__nand2_2 _062_ (.A(ui_in[4]),
    .B(ui_in[0]),
    .Y(_001_));
 sky130_fd_sc_hd__nor3b_2 _063_ (.A(uio_in[2]),
    .B(uio_in[1]),
    .C_N(uio_in[0]),
    .Y(_002_));
 sky130_fd_sc_hd__a221oi_2 _064_ (.A1(ui_in[4]),
    .A2(ui_in[0]),
    .B1(uio_in[2]),
    .B2(uio_in[0]),
    .C1(uio_in[1]),
    .Y(_003_));
 sky130_fd_sc_hd__o22a_2 _065_ (.A1(ui_in[4]),
    .A2(ui_in[0]),
    .B1(_000_),
    .B2(_003_),
    .X(_004_));
 sky130_fd_sc_hd__nor3b_2 _066_ (.A(uio_in[2]),
    .B(uio_in[0]),
    .C_N(uio_in[1]),
    .Y(_005_));
 sky130_fd_sc_hd__and3_2 _067_ (.A(uio_in[2]),
    .B(uio_in[0]),
    .C(uio_in[1]),
    .X(_006_));
 sky130_fd_sc_hd__a32o_2 _068_ (.A1(ui_in[4]),
    .A2(ui_in[0]),
    .A3(_005_),
    .B1(_006_),
    .B2(ui_in[1]),
    .X(_007_));
 sky130_fd_sc_hd__nand3b_2 _069_ (.A_N(uio_in[1]),
    .B(uio_in[0]),
    .C(uio_in[2]),
    .Y(_008_));
 sky130_fd_sc_hd__nor2_2 _070_ (.A(ui_in[0]),
    .B(_008_),
    .Y(_009_));
 sky130_fd_sc_hd__or3_2 _071_ (.A(_004_),
    ...
    .C(_009_),
    .X(uo_out[0]));
 sky130_fd_sc_hd__or2_2 _072_ (.A(ui_in[1]),
    .B(ui_in[5]),
    .X(_010_));
 sky130_fd_sc_hd__nand2_2 _073_ (.A(ui_in[1]),
    .B(ui_in[5]),
    .Y(_011_));
 sky130_fd_sc_hd__xnor2_2 _074_ (.A(ui_in[1]),
    .B(ui_in[5]),
    .Y(_012_));
 sky130_fd_sc_hd__or3b_2 _075_ (.A(uio_in[0]),
    .B(uio_in[1]),
    .C_N(uio_in[2]),
    .X(_013_));
 sky130_fd_sc_hd__nor2_2 _076_ (.A(_012_),
    .B(_013_),
    .Y(_014_));
 sky130_fd_sc_hd__a31o_2 _077_ (.A1(ui_in[1]),
    .A2(ui_in[5]),
    .A3(_005_),
    .B1(_014_),
    .X(_015_));
 sky130_fd_sc_hd__a2bb2o_2 _078_ (.A1_N(ui_in[1]),
    .A2_N(_008_),
    .B1(_006_),
    .B2(ui_in[2]),
    .X(_016_));
 sky130_fd_sc_hd__and3b_2 _079_ (.A_N(uio_in[0]),
    .B(uio_in[1]),
    .C(uio_in[2]),
    .X(_017_));
 sky130_fd_sc_hd__a22o_2 _080_ (.A1(_000_),
    ...
    .B2(ui_in[0]),
    .X(_018_));
 sky130_fd_sc_hd__nand2b_2 _081_ (.A_N(ui_in[0]),
    .B(ui_in[4]),
    .Y(_019_));
 ...
 sky130_fd_sc_hd__nand2_2 _084_ (.A(_001_),
    .B(_012_),
    .Y(_022_));
 sky130_fd_sc_hd__nor3_2 _085_ (.A(uio_in[2]),
    .B(uio_in[0]),
    .C(uio_in[1]),
    .Y(_023_));
 ...
 sky130_fd_sc_hd__or4_2 _088_ (.A(_015_),
    ...
    .D(_025_),
    .X(uo_out[1]));
 sky130_fd_sc_hd__or2_2 _089_ (.A(ui_in[2]),
    .B(ui_in[6]),
    .X(_026_));
 sky130_fd_sc_hd__and2_2 _090_ (.A(ui_in[2]),
    .B(ui_in[6]),
    .X(_027_));
 sky130_fd_sc_hd__nand2_2 _091_ (.A(ui_in[2]),
    .B(ui_in[6]),
    .Y(_028_));
 ...
 sky130_fd_sc_hd__a21bo_2 _095_ (.A1(_030_),
    ...
    .B1_N(_023_),
    .X(_032_));
 sky130_fd_sc_hd__and2b_2 _096_ (.A_N(ui_in[5]),
    .B(ui_in[1]),
    .X(_033_));
 ...
 sky130_fd_sc_hd__nand2_2 _101_ (.A(_000_),
    .B(_026_),
    .Y(_038_));
 sky130_fd_sc_hd__a211oi_2 _102_ (.A1(uio_in[2]),
    .A2(_029_),
    .B1(uio_in[1]),
    .C1(uio_in[0]),
    .Y(_039_));
 sky130_fd_sc_hd__a2bb2o_2 _103_ (.A1_N(ui_in[2]),
    .A2_N(_008_),
    .B1(_017_),
    .B2(ui_in[1]),
    .X(_040_));
 sky130_fd_sc_hd__a22o_2 _104_ (.A1(ui_in[3]),
    .A2(_006_),
    .B1(_027_),
    .B2(_005_),
    .X(_041_));
 ...
 sky130_fd_sc_hd__o21a_2 _106_ (.A1(_037_),
    ...
    .B1(_032_),
    .X(uo_out[2]));
 sky130_fd_sc_hd__or2_2 _107_ (.A(ui_in[3]),
    .B(ui_in[7]),
    .X(_043_));
 sky130_fd_sc_hd__nand2_2 _108_ (.A(ui_in[3]),
    .B(ui_in[7]),
    .Y(_044_));
 ...
 sky130_fd_sc_hd__nand3_2 _111_ (.A(_028_),
    ...
    .C(_045_),
    .Y(_047_));
 sky130_fd_sc_hd__and2b_2 _112_ (.A_N(ui_in[6]),
    .B(ui_in[2]),
    .X(_048_));
 ...
 sky130_fd_sc_hd__o21a_2 _115_ (.A1(_045_),
    ...
    .B1(_050_),
    .X(_051_));
 sky130_fd_sc_hd__and2_2 _116_ (.A(ui_in[2]),
    .B(_017_),
    .X(_052_));
 sky130_fd_sc_hd__and3_2 _117_ (.A(ui_in[3]),
    .B(ui_in[7]),
    .C(_005_),
    .X(_053_));
 sky130_fd_sc_hd__a21o_2 _118_ (.A1(_000_),
    ...
    .B1(_053_),
    .X(_054_));
 sky130_fd_sc_hd__o22a_2 _119_ (.A1(ui_in[3]),
    .A2(_008_),
    .B1(_013_),
    .B2(_045_),
    .X(_055_));
 ...
 sky130_fd_sc_hd__nor4_2 _124_ (.A(uo_out[2]),
    ...
    .D(_058_),
    .Y(zero_flag));
 sky130_fd_sc_hd__nand2b_2 _125_ (.A_N(ui_in[7]),
    .B(ui_in[3]),
    .Y(_059_));
 ...
 sky130_fd_sc_hd__a22o_2 _127_ (.A1(_050_),
    ...
    .B2(_023_),
    .X(carry_out));
 sky130_fd_sc_hd__conb_1 _128_ (.LO(uio_oe[0]));
 sky130_fd_sc_hd__conb_1 _129_ (.LO(uio_oe[1]));
 sky130_fd_sc_hd__conb_1 _130_ (.LO(uio_oe[2]));
 sky130_fd_sc_hd__conb_1 _131_ (.LO(uio_oe[3]));
 sky130_fd_sc_hd__conb_1 _132_ (.LO(uio_oe[4]));
 sky130_fd_sc_hd__conb_1 _133_ (.LO(uio_oe[5]));
 sky130_fd_sc_hd__conb_1 _134_ (.LO(uio_oe[6]));
 sky130_fd_sc_hd__conb_1 _135_ (.LO(uio_oe[7]));
 sky130_fd_sc_hd__conb_1 _136_ (.LO(uio_out[0]));
 sky130_fd_sc_hd__conb_1 _137_ (.LO(uio_out[1]));
 sky130_fd_sc_hd__conb_1 _138_ (.LO(uio_out[2]));
 sky130_fd_sc_hd__conb_1 _139_ (.LO(uio_out[3]));
 sky130_fd_sc_hd__conb_1 _140_ (.LO(uio_out[4]));
 sky130_fd_sc_hd__conb_1 _141_ (.LO(uio_out[5]));
 sky130_fd_sc_hd__conb_1 _142_ (.LO(uio_out[6]));
 sky130_fd_sc_hd__conb_1 _143_ (.LO(uio_out[7]));
 sky130_fd_sc_hd__conb_1 _144_ (.LO(uo_out[6]));
 sky130_fd_sc_hd__conb_1 _145_ (.LO(uo_out[7]));
